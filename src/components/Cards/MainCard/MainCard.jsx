...
export const MainCard = ({
  ...
  if (
    ...
    return <div className="main_card">Loading....</div>;
  } else {
    return (
      <div className="main_card">
        ...
        <div className="second_column">
          <i className={"wi " + iconClass} style={{ fontSize: "7rem" }}></i>
        ...
        <div className="third_column">
          <div className="row">
            <div className="cell">
              <i class="wi wi-umbrella" style={{ fontSize: "2rem" }}></i>
              <h1 className="additional_info">{humidity}%</h1>
              <h1 className="sign">Humidity</h1>
            </div>
            <div className="cell">
              <i class="wi wi-strong-wind" style={{ fontSize: "2rem" }}></i>
          ...
          <div className="row">
            <div className="cell">
              <i class="wi wi-refresh" style={{ fontSize: "2rem" }}></i>
              <h1 className="additional_info">{pressure}hPa</h1>
              <h1 className="sign">Pressure</h1>
            </div>
            <div className="cell">
              <i class="wi wi-day-sunny" style={{ fontSize: "2rem" }}></i>
